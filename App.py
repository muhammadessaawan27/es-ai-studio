...
with tab_movie:
    ...
    # Upload character reference image (Point 7)
...
with tab_image:
    ...
    with tab_txt:
        ...
        # Canva Style text input box (Point 7)
        canva_overlay_text = st.text_input("Canva Text Overlay (تصویر پر پریمیم لکھائی):", placeholder="Example: Sglowina Studio V1.5")
    ...
    # This tab is safely processed using structured Streamlit with blocks (No syntax errors!)
